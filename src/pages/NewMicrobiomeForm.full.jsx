    ...
    <div className="new-microbiome-form-wrapper">
      <form className="new-microbiome-form" onSubmit={handleSubmit}>
        ...
        <div className="form-grid">
          <div className="form-group name-group"><label>Name</label><input name="name" value={formData.name} onChange={handleChange} required /></div>
          <div className="form-group email-group"><label>Email</label><input name="email" value={formData.email} onChange={handleChange} type="email" required /></div>
          <div className="form-group dob-group"><label>Date of Birth</label><input name="dob" type="date" value={formData.dob} onChange={handleChange} required /></div>
          

          <div className="form-group weight-group"><label>Weight</label><div className="row-flex"><select name="weightUnit" value={formData.weightUnit} onChange={handleChange} required><option>KG</option><option>LB</option></select><input name="weight" value={formData.weight} onChange={handleChange} placeholder="Weight" required /></div></div>
          <div className="form-group height-group"><label>Height</label><div className="row-flex"><select name="heightUnit" value={formData.heightUnit} onChange={handleChange} required><option>FT</option><option>CM</option></select><input name="height" value={formData.height} onChange={handleChange} placeholder="Height" required /></div></div>
          <div className="form-group gender-group"><label>Gender at Birth</label><select name="gender" value={formData.gender} onChange={handleChange} required><option>Male</option><option>Female</option><option>Other</option></select></div>
          <div className="form-group country-group"><label>Country of Residence</label><input name="country" value={formData.country} onChange={handleChange} placeholder="country" required /></div>
          <div className="form-group kittype-group"><label>Kit Type</label><select name="kitType" value={formData.kitType} onChange={handleChange} required><option value="" disabled hidden>Please Select KIT Type</option>{kitTypeOptions.map((opt)=> (<option key={opt} value={opt}>{opt}</option>))}</select></div>
          <div className="form-group kitid-group"><label>Kit ID</label>{formData.kitType === "FoodSensitivityMap" ? (
            ...
            <input name="kitId" value={formData.kitId} onChange={handleChange} required />
          )}</div>
        ...
        <div className="section">
          ...
          <div className="antibiotic-row">
            <div className="antibiotic-toggle">
              <button
                type="button"
                className={formData.antibiotics === true ? "antibiotic-pill selected" : "antibiotic-pill"}
              ...
              <button
                type="button"
                className={formData.antibiotics === false ? "antibiotic-pill selected no" : "antibiotic-pill no"}
